...
<head>
    ...
    <title>Cabinet Médical - Vérification du code</title>
    ...
    <main class="w-full max-w-3xl bg-surface-container-lowest overflow-hidden flex flex-col md:flex-row shadow-2xl rounded-3xl">
        ...
        <section class="relative w-full md:w-5/12 bg-primary-container p-5 md:p-6 flex flex-col justify-between text-on-primary overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <h1 class="text-2xl md:text-3xl font-extrabold tracking-tight mb-5 leading-tight">Vérification de votre identité</h1>
                <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="font-semibold text-lg">Sécurité garantie</p>
                            <p class="text-white/70 text-sm">Ce processus protège votre compte contre les accès non autorisés.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="relative z-10 mt-6 glass-card p-4 rounded-2xl flex items-center gap-3">
                ...
                <div>
                    <p class="text-sm font-medium">Étape 2 sur 3</p>
                    <p class="text-xs text-white/70">Saisie du code de vérification</p>
                </div>
            </div>
        </section>

        {{-- Right Side: 6-digit code form --}}
            ...
            <div class="max-w-sm mx-auto w-full">
                <header class="mb-6">
                    <div class="w-12 h-12 bg-primary/10 rounded-2xl flex items-center justify-center mb-4">
                        <span class="material-symbols-outlined text-primary text-2xl" style="font-variation-settings: 'FILL' 1;">dialpad</span>
                    </div>
                    <h2 class="text-2xl font-bold text-on-surface mb-2">Entrez votre code</h2>
                    ...
                    <div class="space-y-1.5 mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input class="w-full pl-12 pr-4 py-3 bg-surface-container-low rounded-xl border-none ring-1 ring-outline/10 focus:ring-2 focus:ring-primary transition-all placeholder:text-outline/50 tracking-widest text-center font-bold text-lg"
                                id="code" name="code" placeholder="8 4 7 2 9 1"
                ...
                <footer class="mt-6 text-center space-y-3">
                    ...
                    <a class="text-sm text-primary font-semibold hover:underline" href="{{ route('password.resend') }}">
