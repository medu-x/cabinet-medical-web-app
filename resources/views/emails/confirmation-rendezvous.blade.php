...
<head>
    ...
    <style>
        ...
        .confirmed-badge { display: inline-block; background: #e6f4ea; color: #166534; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; padding: 5px 14px; border-radius: 999px; margin-bottom: 24px; }
    ...
    <div class="container">
        ...
        <div class="body">
            ...
            <p style="color:#3e494b; font-size:14px; margin-bottom: 20px;">
                Votre demande de rendez-vous a bien été reçue. Voici le récapitulatif de votre consultation :
            </p>

            <span class="confirmed-badge">En attente de confirmation</span>
            ...
            <div class="details-box">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">Cabinet Médical, Casablanca</span>
                </div>
            </div>

            <div class="note">
                Merci de vous présenter 10 minutes avant l'heure de votre rendez-vous. En cas d'empêchement, veuillez nous contacter à l'avance.
            </div>
        </div>
        <div class="footer">
