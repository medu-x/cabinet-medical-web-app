...
<head>
    ...
    <style>
        body { font-family: 'Inter', Arial, sans-serif; background: #f7f9fb; margin: 0; padding: 40px 20px; }
...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p style="color:#3e494b; font-size:14px;">Vous avez demandé à réinitialiser votre mot de passe. Utilisez le code ci-dessous :</p>
